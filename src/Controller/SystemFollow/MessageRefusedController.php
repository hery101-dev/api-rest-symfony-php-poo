...
class MessageRefusedController extends AbstractController
{
    ...
    #[Route('/recruiter/message-refused/{id}', name: 'app_message_refused_recruiter', methods: ['PUT'])]
    public function messageRefused(Request $request, int $id): JsonResponse
    {
        $user = $this->getUser();
        if (!$user) {
